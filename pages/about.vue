<template>
  <div>
    ...
    <p>When I’m not doing UX things, I enjoy playing drums and guitar and have turned my drumming practice into my exercise - you can see what I mean at <NuxtLink to="http://metalwerkout.com">metalwerkout.com</NuxtLink>. I also like gardening and woodwork, and have to endure the fortunes (or lack of them) of Everton Football Club. Thanks Dad!</p>
  </div>
</template>
